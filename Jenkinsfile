node {
    ...
    stage('Deploy') {
	    ...
	    sh "/usr/bin/scp -i /var/jenkins_home/latihan-EC2.pem /var/jenkins_home/workspace/submission-cicd-pipeline-bocahndeso/target/ProjectAkhir.jar  ubuntu@47.128.15.241:/home/ubuntu/ProjectAkhir.jar"
